...
public class Pilha {
    ...
    void ex1() {
        ...
        if (text1.equals(text2)) {
            System.out.println("Esse texto eh um palíndromo!\n");
        } else {
            System.out.println("Esse texto nao é um palíndromo!\n");
        }
    ...
    void ex2() {
        ...
        for (int i = 0; i <= 5; i++) {
            ...
            String verificar = JOptionPane.showInputDialog(null, "Você deseja adicionar uma chave no item? ");
