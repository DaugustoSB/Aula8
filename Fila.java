...
public class Fila {
    ...
    void ex4() {
        ...
        for (int i = 0; i <= filaF1.length - 1; i++) {
            System.out.println(
                    "Valor da fila F1 na posicao " + i + " eh: " + filaF1[i] + " e da fila F2 é: " + filaF2[i] + ".");
        }
    }
    ...
    void primeiroFila(Object obj){
        System.out.println("\nO primeiro avião na fila é o " + ((Aviao) obj).nomeAviao + " , de código "
        + ((Aviao) obj).idAviao + "\n");
    }
    ...
    void libeVoo() {
        ...
        obj = filaAviao.get(0);
        String resposta = "";
        resposta = JOptionPane.showInputDialog(null, "Deseja autoruzar o avião " + ((Aviao) obj).nomeAviao + " de código "
                + ((Aviao) obj).idAviao + " a decolar?");

        if ("SIM".equals(resposta)) {
            System.out.println("O avião " + ((Aviao) obj).nomeAviao + " com o código " + ((Aviao) obj).idAviao
                    + " ganhou autorização para voar!\n");
            remover();
        } else {
    ...
    void ex3() {
        for (int i = 0; i <= filaAviao.size() - 1; i++) {
            ...
            obj = filaAviao.get(i);
            System.out
                    .println("O avião " + ((Aviao) obj).nomeAviao + " esta na fila ocupando a " + (i + 1) + " posição!");
        }
    }
    ...
    void ex5() {
        ...
        for (int i = 0; i <= topoFila - 1; i++) {
            System.out.println("O valor da fila na posição " + i + " é: " + filaSorteio[i]);
        }
        System.out.println("\n");
        int j = 0;
